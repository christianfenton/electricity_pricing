        ...
        df = pd.DataFrame(
            {
                ...
                + list(range(2, 49)),  # Period 1 appears twice
            }
        )
        is_valid, errors = validate_settlement_periods(df)
        assert is_valid is False
